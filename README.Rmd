...
This is an accompanying repository for the paper *"On the inclusion of non-concurrent controls in platform trials with an interim analysis''* by Pavla Krotka, Martin Posch, and Marta Bofill Roig. It contains the code to reproduce all simulations and figures, as well as the case study presented in the paper.
