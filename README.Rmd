...
This is an accompanying repository for the paper *"On the inclusion of non-concurrent controls in platform trials with a futility interim analysis''* by Pavla Krotka, Martin Posch, and Marta Bofill Roig. It contains the code to reproduce all simulations and figures presented in the manuscript and supplementary material.
...
- Folder **functions**:
    ...
    This folder contains all functions necessary to run the simulation study:
...
- Folder **paper_sim**:
    ...
    - *simscript_paper_final.R*: This script contains the code to reproduce all simulations included in the paper and supplementary material. The results for the individual scenarios are then saved in the subfolder *results_final*.
    - *figures_paper_final.Rmd*: This file contains the code to create all figures presented in the paper and the supplementary material. The figures are saved in the subfolder *figures* in a .pdf and .tiff formats.
    
## Working directories

The required working directory for each code file is the folder where this file is located, i.e., for running the simulations, the working directory should be set to the folder **paper_sim**.
