---
title: "On the inclusion of non-concurrent controls in platform trials with a futility interim analysis"
subtitle: "Figures"
...
get_bias <- function(alpha_1, n01, n11, n02, n12, theta_1){
  ...
  # Marginal bias
  rho*sd_1*dnorm(c_1 - (theta_1/sd_1))
}
...
get_bias_cond <- function(alpha_1, n01, n11, n02, n12, theta_1){
  ...
  # (rho*sd_1*dnorm(c_1 - (theta_1/sd_1))) / (1-pnorm(c_1 - (theta_1/sd_1)))
  exp(log(rho*sd_1)+dnorm((c_1 - (theta_1/sd_1)), log = T) - (pnorm((-c_1 + (theta_1/sd_1)), log.p = T))) # equivalent to the formula in paper, but using exp(log(.))
...
ggsave("figures/Fig_maxbias.tiff", height = 5, width = 10)
```
...
plot_bias_alpha1 <- rbind(results_scenarios_t1e_alpha1, results_scenarios_t1e_alpha1_supp) %>%
  select(futility_bound, trend_pattern, lambda0, bias_arm2_unadj, bias_arm2_adj_theta1_per1, bias_arm2_adj_theta1_per2, bias_arm2_adj_theta1_per12, bias_arm2_adj_theta1_rao,
  ...
  mutate(trend_pattern = ifelse(lambda0==0, "notrend", trend_pattern),
         ...
         Theta_2 = factor(Theta_2, levels = c("arm2_unadj", "arm2_adj_theta1_per12", "arm2_adj_theta1_per2", "arm2_adj_theta1_per1", "arm2_adj_theta1_rao")),
         sd_err_bias = sd_bias/sqrt(nsim))

my_palette = c("arm2_unadj" = "firebrick",
               "arm2_adj_theta1_per12" = "royalblue3",
               "arm2_adj_theta1_per2" = "chocolate1", 
               "arm2_adj_theta1_per1" = "chartreuse4",
               "arm2_adj_theta1_rao" = "purple")
...
ggplot(plot_bias_alpha1) +
  ...
  scale_color_manual(labels = c(TeX("${\\tilde{\\theta}}_2$ unadjusted"),
                                TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ from periods 1 and 2"), 
                                TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ from period 2"),
                                TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ from period 1"),
                                TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ CUMVUE")), values = my_palette) +
  # ylim(-0.005, 0.068) + #ylim(-0.0015, 0.0125) +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave("figures/Fig_marg_bias_alpha1.pdf", height=6, width=10)
ggsave("figures/Fig_marg_bias_alpha1.tiff", height=6, width=10)
```
...
get_bias_cond <- function(Data, OP, n.sim = nsim){
  return(Data %>%
           select(!!OP, arm_1_cont, bias_arm2_unadj_cond, bias_arm2_adj_theta1_per1_cond, bias_arm2_adj_theta1_per2_cond, 
                  bias_arm2_adj_theta1_per12_cond, bias_arm2_adj_theta1_rao_cond,
                  sd_bias_arm2_unadj_cond, sd_bias_arm2_adj_theta1_per1_cond, 
                  sd_bias_arm2_adj_theta1_per2_cond, sd_bias_arm2_adj_theta1_per12_cond, sd_bias_arm2_adj_theta1_rao_cond) %>%
           ...
           mutate(sd_err_bias = sd_bias/sqrt(n.sim*arm_1_cont),
                  Theta_2 = factor(Theta_2, 
                                   levels = c("arm2_unadj_cond", "arm2_adj_theta1_per12_cond", 
                                              "arm2_adj_theta1_per2_cond", "arm2_adj_theta1_per1_cond", "arm2_adj_theta1_rao_cond"))))
}

my_palette = c("arm2_unadj_cond" = "firebrick",
               "arm2_adj_theta1_per12_cond" = "royalblue3",
               "arm2_adj_theta1_per2_cond" = "chocolate1",
               "arm2_adj_theta1_per1_cond" = "chartreuse4",
               "arm2_adj_theta1_rao_cond" = "purple")
...
Fig_cond_bias <- ggarrange(ggplot(get_bias_cond(results_scenarios_t1e_alpha1, "futility_bound")) +
                             ...
                             scale_color_manual(labels = c(TeX("${\\tilde{\\theta}}_2$ unadjusted"),
                                                           ...
                                                           TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ from period 2"),
                                                           TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ from period 1"),
                                                           TeX("$\\tilde{\\theta}^A_2$ with $\\hat{\\theta}_1$ CUMVUE")), 
                                                values = my_palette) +
                             #ylim(-0.014, 0.051) +
                           ...
                           ggplot(get_bias_cond(results_scenarios_t1e_lambda, "lambda0")) +
                             ...
                             # geom_errorbar(aes(x = lambda0, y = Bias_cond, ymin = Bias_cond - sd_err_bias, ymax = Bias_cond + sd_err_bias, color = Theta_2), width = 0.04 * ((0.15 - (-0.15))/(1-0))) +
                             labs(x = TeX("$\\lambda$")) +
                             scale_color_manual(values = my_palette) +
                             #ylim(-0.014, 0.051) +
                             scale_y_continuous(n.breaks = 7, limits = c(-0.016, 0.055)) + 
...
ggsave("figures/Fig_cond_bias.tiff", height = 6, width = 10)
```
...
get_MSE_cond <- function(Data, OP){
  return(Data %>%
           select(!!OP, MSE_arm2_unadj_cond, MSE_arm2_adj_theta1_per1_cond, 
                  MSE_arm2_adj_theta1_per2_cond, MSE_arm2_adj_theta1_per12_cond, MSE_arm2_adj_theta1_rao_cond, MSE_arm2_sep) %>%
           pivot_longer(cols = c(-!!OP), names_to = "Theta_2", values_to = "MSE_cond") %>%
           mutate(Theta_2 = factor(Theta_2, 
                                   levels = c("MSE_arm2_unadj_cond", "MSE_arm2_adj_theta1_per12_cond", 
                                              "MSE_arm2_adj_theta1_per2_cond", "MSE_arm2_adj_theta1_per1_cond", 
                                              "MSE_arm2_adj_theta1_rao_cond", "MSE_arm2_sep"))))
}



my_palette = c("MSE_arm2_unadj_cond" = "firebrick",
               "MSE_arm2_adj_theta1_per12_cond" = "royalblue3",
               "MSE_arm2_adj_theta1_per2_cond" = "chocolate1",
               "MSE_arm2_adj_theta1_per1_cond" = "chartreuse4",
               "MSE_arm2_adj_theta1_rao_cond" = "purple",
               "MSE_arm2_sep" = "black")
...
ggsave("figures/Fig_cond_MSE.tiff", height = 6, width = 10)
```
...
get_t1e_cond <- function(Data, OP, n.sim = nsim){
  ...
  return(Data %>%
           select(!!OP, arm_1_cont, reject_h02_unadj_cond, reject_h02_adj_theta1_per1_cond, 
                  reject_h02_adj_theta1_per2_cond, reject_h02_adj_theta1_per12_cond, reject_h02_adj_theta1_rao_cond) %>%
           ...
           mutate(pred_int_cond_1 = p-z.alpha*sqrt(p*(1-p)/(n.sim*arm_1_cont)),
                  ...
                  Theta_2 = factor(Theta_2, 
                                   levels = c("reject_h02_unadj_cond", "reject_h02_adj_theta1_per12_cond", 
                                              "reject_h02_adj_theta1_per2_cond", "reject_h02_adj_theta1_per1_cond", "reject_h02_adj_theta1_rao_cond"))))
}



my_palette = c("reject_h02_unadj_cond" = "firebrick",
               "reject_h02_adj_theta1_per12_cond" = "royalblue3",
               "reject_h02_adj_theta1_per2_cond" = "chocolate1",
               "reject_h02_adj_theta1_per1_cond" = "chartreuse4",
               "reject_h02_adj_theta1_rao_cond" = "purple")
...
ggsave("figures/Fig_cond_t1e.tiff", height = 6, width = 10)
```
...
get_power_cond <- function(Data, OP){
  ...
  return(Data %>%
           select(!!OP, reject_h02_unadj_cond, reject_h02_adj_theta1_per1_cond, 
                  reject_h02_adj_theta1_per2_cond, reject_h02_adj_theta1_per12_cond, 
                  reject_h02_adj_theta1_rao_cond, reject_h02_sep) %>%
           pivot_longer(cols = c(-!!OP), names_to = "Theta_2", values_to = "pow_cond") %>%
           mutate(Theta_2 = factor(Theta_2, 
                                   levels = c("reject_h02_unadj_cond", "reject_h02_adj_theta1_per12_cond", 
                                              "reject_h02_adj_theta1_per2_cond", "reject_h02_adj_theta1_per1_cond", 
                                              "reject_h02_adj_theta1_rao_cond", "reject_h02_sep"))))
}
...
ggsave("figures/Fig_cond_pow.tiff", height = 6, width = 10)
```
...
get_bias_marg <- function(Data, OP){
  return(Data %>%
           select(!!OP, arm_1_cont, bias_arm2_unadj, bias_arm2_adj_theta1_per1, 
                  bias_arm2_adj_theta1_per2, bias_arm2_adj_theta1_per12, bias_arm2_adj_theta1_rao,
                  sd_bias_arm2_unadj, sd_bias_arm2_adj_theta1_per1, sd_bias_arm2_adj_theta1_per2, 
                  sd_bias_arm2_adj_theta1_per12, sd_bias_arm2_adj_theta1_rao) %>%
           pivot_longer(cols = c(-!!OP, -arm_1_cont), names_to = c(".value", "method"), names_pattern = "(bias|sd_bias)_(.*)") %>%
           rename(Bias_cond = bias,
                  Theta_2 = method) %>%
           mutate(sd_err_bias = sd_bias/sqrt(nsim),
                  Theta_2 = factor(Theta_2, 
                                   levels = c("arm2_unadj", "arm2_adj_theta1_per12", "arm2_adj_theta1_per2", 
                                              "arm2_adj_theta1_per1", "arm2_adj_theta1_rao"))))
}
...
ggsave("figures/Fig_marg_bias_supp.tiff", height = 12, width = 10)
```
...
get_MSE_marg <- function(Data, OP){
  return(Data %>%
           select(!!OP, MSE_arm2_unadj, MSE_arm2_adj_theta1_per1, MSE_arm2_adj_theta1_per2, 
                  MSE_arm2_adj_theta1_per12, MSE_arm2_adj_theta1_rao, MSE_arm2_sep) %>%
           pivot_longer(cols = c(-!!OP), names_to = "Theta_2", values_to = "MSE") %>%
           mutate(Theta_2 = factor(Theta_2, 
                                   levels = c("MSE_arm2_unadj", "MSE_arm2_adj_theta1_per12", 
                                              "MSE_arm2_adj_theta1_per2", "MSE_arm2_adj_theta1_per1", 
                                              "MSE_arm2_adj_theta1_rao", "MSE_arm2_sep"))))
}

my_palette = c("MSE_arm2_unadj" = "firebrick",
               "MSE_arm2_adj_theta1_per12" = "royalblue3",
               "MSE_arm2_adj_theta1_per2" = "chocolate1",
               "MSE_arm2_adj_theta1_per1" = "chartreuse4",
               "MSE_arm2_adj_theta1_rao" = "purple",
               "MSE_arm2_sep" = "black")
...
ggsave("figures/Fig_marg_MSE_supp.tiff", height = 12, width = 10)
```
...
get_t1e_marg <- function(Data, OP, n.sim = nsim){
  ...
  return(Data %>%
           select(!!OP, arm_1_cont, reject_h02_unadj, reject_h02_adj_theta1_per1, reject_h02_adj_theta1_per2, 
                  reject_h02_adj_theta1_per12, reject_h02_adj_theta1_rao) %>%
           ...
           mutate(pred_int_1 = p-z.alpha*sqrt(p*(1-p)/(n.sim)),
                  ...
                  Theta_2 = factor(Theta_2, 
                                   levels = c("reject_h02_unadj", "reject_h02_adj_theta1_per12", "reject_h02_adj_theta1_per2", 
                                              "reject_h02_adj_theta1_per1", "reject_h02_adj_theta1_rao"))))
}


my_palette = c("reject_h02_unadj" = "firebrick",
               "reject_h02_adj_theta1_per12" = "royalblue3",
               "reject_h02_adj_theta1_per2" = "chocolate1",
               "reject_h02_adj_theta1_per1" = "chartreuse4",
               "reject_h02_adj_theta1_rao" = "purple")
...
ggsave("figures/Fig_marg_t1e_supp.tiff", height = 12, width = 10)
```
...
get_power_marg <- function(Data, OP){
  ...
  return(Data %>%
           select(!!OP, reject_h02_unadj, reject_h02_adj_theta1_per1, reject_h02_adj_theta1_per2, 
                  reject_h02_adj_theta1_per12, reject_h02_adj_theta1_rao, reject_h02_sep) %>%
           pivot_longer(cols = c(-!!OP), names_to = "Theta_2", values_to = "pow") %>%
           mutate(Theta_2 = factor(Theta_2, 
                                   levels = c("reject_h02_unadj", "reject_h02_adj_theta1_per12", 
                                              "reject_h02_adj_theta1_per2", "reject_h02_adj_theta1_per1", 
                                              "reject_h02_adj_theta1_rao", "reject_h02_sep"))))
}
...
ggsave("figures/Fig_marg_pow_supp.tiff", height = 12, width = 10)
```
...
ggsave("figures/Fig_cond_bias_supp.tiff", height = 10, width = 10)
```
...
ggsave("figures/Fig_cond_MSE_supp.tiff", height = 10, width = 10)
```
...
ggsave("figures/Fig_cond_t1e_supp.tiff", height = 10, width = 10)
```
...
ggsave("figures/Fig_cond_pow_supp.tiff", height = 10, width = 10)
```
